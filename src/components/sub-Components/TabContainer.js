    ...
    <React.Fragment>
      <div className="container-fluid tab-container">
        <div className="row">
          ...
          <div onClick={setActiveTab} className="tab-select col-1 active btn btn-primary">
            <FontAwesomeIcon icon={["fas", "table"]} size="1x"  /> 
            <br />
            <span className="d-none d-md-inline-flex">CHART</span>
          </div>
          <div onClick={setActiveTab} className="tab-select col-1 inactive btn btn-primary">
          <FontAwesomeIcon icon={["fas", "chart-line"]} size="1x"  /> 
          <br />
          <span className="d-none d-md-inline-flex">GRAPH</span>
          </div>
          <div className="col-10 inactive">
          </div>
